...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      challenge_responses: {
        Row: {
          argument_votes: number | null
          challenge_id: string | null
          created_at: string | null
          gate_passed: boolean | null
          id: string
          stance: Database["public"]["Enums"]["stance_enum"]
          user_id: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "challenge_responses_voice_post_id_fkey"
            columns: ["voice_post_id"]
            isOneToOne: false
      ...
      challenges: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "challenges_voice_post_id_fkey"
            columns: ["voice_post_id"]
            isOneToOne: false
            referencedRelation: "voice_posts"
            referencedColumns: ["id"]
