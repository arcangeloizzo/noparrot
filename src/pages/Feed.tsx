      ...
      {selectedFocusForComments && (
        <CommentsDrawer
          post={{
            ...
            preview_img: selectedFocusForComments.data.image_url || null,
            full_article: selectedFocusForComments.data.deep_content || null,
            article_content: selectedFocusForComments.data.deep_content || null,
            trust_level: selectedFocusForComments.data.trust_score || null,
            stance: null,
            sources: selectedFocusForComments.data.sources || null,
            quoted_post_id: null,
