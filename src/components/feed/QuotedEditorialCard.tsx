...
export const QuotedEditorialCard = ({ 
  ...
  // Check if summary needs truncation (approximate 5 lines = ~300 chars)
  const needsTruncation = summary && summary.length > 300;
  ...
  return (
    <>
      ...
      {/* Full Text Modal for long summaries */}
      <FullTextModal
        isOpen={showFullText}
        ...
        author={{
          name: 'Il Punto',
          username: EDITORIAL.HANDLE.replace('@', ''),
          avatar: EDITORIAL.AVATAR_IMAGE,
        }}
        variant="editorial"
      />
    </>
