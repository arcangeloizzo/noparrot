          ...
          <div className="flex-1 flex flex-col justify-center px-2">
            ...
            {hasLink && isSpotify ? (
              ...
              >
                ...
                {/* PULSE Badge for Spotify (replaces static badge when popularity available) */}
                {articlePreview?.popularity !== undefined ? (
                  ...
                  /* Fallback: Static Spotify badge when no popularity data */
                  <div className="flex justify-center">
