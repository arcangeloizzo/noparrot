              ...
              {hasLink && isTwitter ? (
                ...
                >
                  ...
                  {(articlePreview?.image || post.preview_img) && (
                    <div className="flex-1 min-h-[100px] max-h-[35vh] w-full flex items-center justify-center mb-4">
                      <img
                        src={articlePreview?.image || post.preview_img}
                        alt=""
                        className="max-h-full aspect-square object-cover rounded-2xl border border-slate-200 dark:border-white/10"
                      />
                    </div>
                  )}
                  ...
                  <div className="flex flex-shrink-0 justify-center">
                    <div className="flex items-center gap-2 bg-[#1DB954] hover:bg-[#1DB954]/90 border border-[#1DB954]/30 px-4 py-2 rounded-full shadow-md active:scale-95 transition-all">
                      ...
                      <span className="text-white text-xs font-bold uppercase tracking-wider">Ascolta su Spotify</span>
                    </div>
                  </div>
                </div>
