// Custom NOPARROT icons using Lucide-style SVGs
...
export const EyeOffIcon = ({ className }: { className?: string }) => (
  <svg 
    ...
    strokeLinejoin="round"
  >
    <path d="M17.94 17.94C16.2306 19.243 14.1491 19.9649 12 20C5 20 1 12 1 12C2.24389 9.68192 3.96914 7.65663 6.06 6.06L17.94 17.94Z"/>
    <path d="M9.9 4.24C10.5883 4.0789 11.2931 3.99836 12 4C19 4 23 12 23 12C22.393 13.1356 21.6691 14.2048 20.84 15.19L9.9 4.24Z"/>
    <path d="M1 1L23 23"/>
  </svg>
);
...
export const AtSignIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M16 8V13C16 13.5304 16.2107 14.0391 16.5858 14.4142C16.9609 14.7893 17.4696 15 18 15C18.5304 15 19.0391 14.7893 19.4142 14.4142C19.7893 14.0391 20 13.5304 20 13V12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20C13.6418 20 15.1618 19.5 16.4 18.6"/>
  </svg>
);
