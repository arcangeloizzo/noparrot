...
-- Step 2.1: add ratio/orientation/ambient columns to existing tables.
-- Step 2.2 will refactor publish-post + edge functions to populate these.

-- --- Table: media (user uploads + future link previews convergence) ---
...
-- --- Table: daily_focus (Il Punto — kept separate per architectural decision) ---
...
-- NOTE: posts.preview_img will be deprecated in step 2.2 in favor of the media table.
-- DO NOT add columns to posts in this migration.
